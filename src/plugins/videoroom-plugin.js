...
class VideoRoomHandle extends Handle {
   ...
   */
  async joinSubscriber({ room, feed, audio, video, offer_video,offer_audio,data, private_id, sc_substream_layer, sc_substream_fallback_ms, sc_temporal_layers, autoupdate, token }) {
    const body = {
      request: REQUEST_JOIN,
